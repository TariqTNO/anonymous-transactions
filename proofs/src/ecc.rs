//! Copy from [ZCash][zcash].
//!
//! Gadgets implementing Jubjub elliptic curve operations.
//!
//! [zcash]: https://github.com/zcash/librustzcash/blob/master/zcash_proofs/src/circuit/ecc.rs
...
mod test {
    ...
    fn test_into_edwards() {
        ...
        for _ in 0..100 {
            ...
            assert_eq!(q.u.get_value().unwrap(), u);
            assert_eq!(q.v.get_value().unwrap(), v);
    ...
    fn test_edwards_fixed_base_multiplication() {
        ...
        for _ in 0..100 {
            ...
            let p = *primitives::constants::NOTE_COMMITMENT_RANDOMNESS_GENERATOR;
    ...
    fn test_edwards_addition() {
        ...
        for _ in 0..100 {
            ...
            assert_eq!(p3.u.get_value().unwrap(), u2);
            assert_eq!(p3.v.get_value().unwrap(), v2);
    ...
    fn test_edwards_doubling() {
        ...
        for _ in 0..100 {
            ...
            assert_eq!(p2.u.get_value().unwrap(), u1);
            assert_eq!(p2.v.get_value().unwrap(), v1);
        }
    }
    ...
    fn test_montgomery_addition() {
        ...
        for _ in 0..100 {
            ...
            assert_eq!(p3.x.get_value().unwrap(), x2);
            assert_eq!(p3.y.get_value().unwrap(), y2);
